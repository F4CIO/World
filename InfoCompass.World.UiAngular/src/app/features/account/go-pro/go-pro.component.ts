...
@Component({
  selector: 'app-go-pro',
  templateUrl: './go-pro.component.html',
  styleUrls: ['./go-pro.component.css']
})
export class GoProPageComponent extends BaseForm implements OnInit {
    ...
    ) 
  {
    ...
    this.pageTitle = 'Go Pro';
  }

  protected override childSpecific_NgOnInit(): void {
    console.log('Go Pro Component ngOnInit');
    ...
    this.requestBody = {
        ...
        message: 'User clicked Go Pro button',
        isRead: false,
        isVisible: false,
        note: '',
        threadId: 0,
  ...
  protected override childSpecific_ApiCall(): Observable<any> {
    ...
    console.log('Posting go pro usermessage:');
  ...
  protected override childSpecific_OnSuccess(serverResponseForUi: any): void {
    ...
    var message = 'Posted message successfully. server response='+serverResponseForUi.data;
    console.log(message);
