...
namespace CraftSynth.BuildingBlocks.IO.Xml
{
	public partial class Misc
	{
        ...
        public static T Deserialize<T>(string xml)
        {
            ...
            d.LoadXml(xml);
            r = CraftSynth.BuildingBlocks.IO.Xml.Misc.Deserialize<T>(d.DocumentElement);
		...
		public static object Deserialize(string filePath, bool useSoapFormatter)
		{
			...
			try
			{
				...
				if (useSoapFormatter)
				{
					...
					//returnValue = new XmlSerializer(myTypeMapping).Deserialize(fileStream);
		...
		public static void Serialize(object myObject, string fileName, bool useSoapFormatter)
		{
			...
			try
			{
				...
				if (useSoapFormatter)
				{
					throw new NotImplementedException();//ODO: port to DotNet6
					//SoapFormatter soapFormatter = new SoapFormatter();
