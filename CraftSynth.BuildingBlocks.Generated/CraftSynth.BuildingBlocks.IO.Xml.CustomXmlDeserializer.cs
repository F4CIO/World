...
namespace CraftSynth.BuildingBlocks.IO.Xml.CustomXmlSerializer
{
    public class CustomXmlDeserializer : CustomXmlSerializerBase
    {
        ...
        void DeserializeComplexType(object obj, Type objType, XmlNode firstChild)
        {
            ...
            for (XmlNode node = firstChild; node != null; node = node.NextSibling)
            {
	            ...
	            fieldName = fieldName.Replace("_oI_", "<");
	            fieldName = fieldName.Replace("_Io_", ">");
   ...
   //         // create a new instance of the object
			//if (objType == typeof(System.Drawing.Font))
			//{//Fix for: No parameterless constructor defined for this object. //TODO: test
			//	obj = new Font(FontFamily.GenericSansSerif, (float)12, FontStyle.Regular);// Activator.CreateInstance(objType, new object[] { FontFamily.GenericSansSerif, (float)12, FontStyle.Regular });
			//}
			//else if (objType == typeof(System.Drawing.FontFamily))
			//{//Fix for: No parameterless constructor defined for this object. //TODO: test
			//	obj = FontFamily.GenericSansSerif;// new Font Activator.CreateInstance(objType, new object[] { "Arial" });
			//}
			//else
			{
